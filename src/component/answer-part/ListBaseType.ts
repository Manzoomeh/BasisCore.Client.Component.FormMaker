...
export default abstract class ListBaseType extends AnswerPart {
    constructor(question: IQuestion, part: IQuestionPart, layout: string, options: IFormMakerOptions, container: Element) {
